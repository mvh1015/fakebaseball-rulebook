...
\nonumsubsection{Article I: Organization}{sec:ARTICLE I}
\begin{deepEnumerate}
...
\nonumsubsection{Article II: The Committee}{sec:ARTICLE II}
\begin{deepEnumerate}
...
\nonumsubsection{Article III: Proposals}{sec:ARTICLE III}
\begin{deepEnumerate}
...
\nonumsubsection{Article V: Emergency Votes}{sec:ARTICLE V}
\begin{deepEnumerate}
...
\nonumsubsection{Article VI: Breach of Conduct}{sec:ARTICLE VI}
\begin{deepEnumerate}
...
\nonumsubsection{Article VII: Amendments}{sec:ARTICLE VII}
\begin{deepEnumerate}
