...
\begin{deepEnumerate}
	...
	\end{deepEnumerate}
	\item Free agents signed are not eligible to play for their MLR team during the current MLR session or game.
	\begin{deepEnumerate}
...
\begin{deepEnumerate}
	...
	The OOTC can choose the acting GM at their sole discretion if the primary team captain is not suitable for any reason.
	\begin{deepEnumerate}
	...
	\item In the event no teammate is chosen or in cases of their being denied by the commissioner's office,
	the commissioner's office will submit 3 candidates to the team.	One of these candidates must be chosen by the team to become the new GM.
