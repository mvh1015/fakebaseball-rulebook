...
\begin{deepEnumerate}
	...
	\begin{deepEnumerate}
		\item A pinch-hitting GM (see player-GM rules) % TODO LINK
...
\begin{deepEnumerate}
	...
	\begin{deepEnumerate}
		...
		\begin{deepEnumerate}
			\item Reporter accounts are the only exception (see reporter rules) % TODO LINK
		\end{deepEnumerate}
	\end{deepEnumerate}
...
\begin{deepEnumerate}
	...
	or one set by the commissioner’s office (see game rules). % TODO LINK
	\begin{deepEnumerate}
		...
		\begin{deepEnumerate}
			...
			and have a special pitching range (see ranges index). % TODO LINK
		\end{deepEnumerate}
		\item GMs as players
		\begin{deepEnumerate}
...
\begin{deepEnumerate}
	...
	\begin{deepEnumerate}
		...
		\item Teams must be able to field a valid lineup (see lineup rules) % TODO LINK
...
\begin{deepEnumerate}
	...
	(see substitution rules and game procedure rules 3.b.ii.1 3.b.ii.3). % TODO LINK
	\begin{deepEnumerate}
